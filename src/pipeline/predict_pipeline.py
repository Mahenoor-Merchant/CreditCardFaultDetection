...
class PredictionPipeline:
    ...
    def save_input_files(self)-> str:
        ...
        try:
            ...
            input_csv_file.save(r"D:\DataScience\MLProjects\CreditCardFaultDetetction\prediction_artifacts\input_csv_file")
    ...
    def get_predicted_dataframe(self, input_dataframe_path:pd.DataFrame):
        ...
        try:
            ...
            prediction_column_name : str = "default payment next month"
            input_dataframe: pd.DataFrame = pd.read_csv(r"D:\DataScience\MLProjects\CreditCardFaultDetetction\prediction_artifacts\input_csv_file")
            
            input_dataframe = input_dataframe.drop("default payment next month", axis=1)
